...
public class ExhibitsByHallServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if(hallIdString.isEmpty()) {
                exhibits = EXHIBIT_SERVICE.getAll();
            } else {
                int authorId = Integer.parseInt(hallIdString);
                exhibits = EXHIBIT_SERVICE.getByHallId(authorId);
            }
